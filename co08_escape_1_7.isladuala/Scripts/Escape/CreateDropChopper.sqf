...
private ["_spawnPos", "_side", "_minSkill", "_maxSkill", "_dropUnits", "_debug", "_chopper", "_group", "_pilot", "_gunner1", "_gunner2", "_currentInstanceNo", "_crewType", "_chopperType", "_dropPosition"];
...
_chopper = "ibr_gazelle" createVehicle _spawnPos;
...
[_chopper, _dropUnits, _dropPosition, _debug] execVM "Scripts\Escape\DropChopper.sqf";
