        ...
        if (!_isExecuted && time > _surpriseTimeSec) then {
            ...
            if (call _condition) then {
                ...
                if (_surpriseID == "DROPCHOPPER") then {
                    ...
                    [group _soldier, drn_searchAreaMarkerName, _dropPosition, drn_var_Escape_DebugSearchGroup] execVM "Scripts\DRN\SearchGroup\SearchGroup.sqf";
                    [getMarkerPos "drn_dropChopperStartPosMarker", east, "ibr_gazelle", "Ins_Soldier_Pilot", _dropUnits, _dropPosition, _minEnemySkill, _maxEnemySkill, drn_var_Escape_debugDropChoppers] execVM "Scripts\Escape\CreateDropChopper.sqf";
                ...
                if (_surpriseID == "RUSSIANSEARCHCHOPPER") then {
                    ...
                    _chopper = "ibr_gazelle_armed" createVehicle getMarkerPos "drn_russianSearchChopperStartPosMarker";
                    _chopper lock false;
