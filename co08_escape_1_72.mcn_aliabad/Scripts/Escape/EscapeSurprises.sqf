        ...
        if (!_isExecuted && time > _surpriseTimeSec) then {
            ...
            if (call _condition) then {
                ...
                if (_surpriseID == "DROPCHOPPER") then {
                    ...
                    [getMarkerPos "drn_dropChopperStartPosMarker", east, "Mi17_TK_EP1", "Ins_Soldier_Pilot", _dropUnits, _dropPosition, _minEnemySkill, _maxEnemySkill, drn_var_Escape_debugDropChoppers] execVM "Scripts\Escape\CreateDropChopper.sqf";
                ...
                if (_surpriseID == "RUSSIANSEARCHCHOPPER") then {
                    ...
                    _chopper = "Mi24_D_TK_EP1" createVehicle getMarkerPos "drn_russianSearchChopperStartPosMarker";
                    _chopper lock false;
