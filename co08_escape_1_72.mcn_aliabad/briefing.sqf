...

{
    if (!isNil "_x") then {
        ...
        _x createDiaryRecord ["Diary", ["Intelligence Revealed", "The Takistani Army seems to know about the upcoming invasion, and works hard with defensive preparations. They have stationed ammunition depots all over Aliabad, as well as advanced communication centers guarded by heavy armor."]];
