...

{
    if (!isNil "_x") then {
        ...
        _x createDiaryRecord ["Diary", ["Intelligence Revealed", "The Red Star Movement seems to know about the upcoming invasion, and works hard with defensive preparations. They have stationed ammunition depots all over Aliabad, as well as advanced communication centers guarded by heavy armor."]];
        _x createDiaryRecord ["Diary", ["Background", "Before the invasion of Aliabad a group of highly skilled army specialists were sent into the heart of the enemy's territory. The goal of their mission was to gather intelligence, classified as top priority information, of the Red Star Movement's defensive structures. While the mission in itself was very successful and revealed even more useful information than hoped for, the withdrawal from Aliabad was not. On the small and snaky roads of Aliabad they made one single mistake and suddenly found themselves lost. If even just for a minute, it was enough to shortly thereafter run straight into a heavily guarded road block. Without a chance to fight they were caught and taken prisoners to a temporary outdoor prison."]];
        _x createDiaryRecord ["Diary", ["Global Background", "The United States has secretly and for some time been planning the invasion of Aliabad beginning in a couple of weeks."]];
