...
if (!isNull player) then {
    [_volume, _showIntro, _showPlayerMapAndCompass, _isJipPlayer, _useRevive] spawn {
        ...
        if (_isJipPlayer) then {
            ...
            sleep 1;
            if (_showIntro) then {
                ["<t size='0.9'>" + "AT presents" + "</t>",0.02,0.3,2,-1,0,3010] spawn bis_fnc_dynamicText;
            };
            ...
            if (_showIntro) then {            
                ...
                ["<t size='0.9'>" + "Escape Celle" + "</t>",0.02,0.3,2,-1,0,3011] spawn bis_fnc_dynamicText;
                ...
                0 cutText ["", "BLACK FADED"];
                ["Somewhere near Celle", str (date select 2) + "/" + str (date select 1) + "/" + str (date select 0) + " " + str (date select 3) + ":00"] spawn BIS_fnc_infoText;
            };
        };
