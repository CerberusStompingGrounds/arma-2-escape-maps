        ...
        if (!_isExecuted && time > _surpriseTimeSec) then {
            ...
            if (call _condition) then {
                ...
                if (_surpriseID == "DROPCHOPPER") then {
                    ...
                    [getMarkerPos "drn_dropChopperStartPosMarker", east, "Mi17_Ins", "Ins_Soldier_Pilot", _dropUnits, _dropPosition, _minEnemySkill, _maxEnemySkill, drn_var_Escape_debugDropChoppers] execVM "Scripts\Escape\CreateDropChopper.sqf";
